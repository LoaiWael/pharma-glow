...
/** Curated home tiles that navigate to dedicated pages (not API-driven). */
export const CURATED_HOME_CATEGORIES: HomeCategory[] = [
  {
    id: 'skincare',
...
/** API category slugs that already have dedicated storefront pages. */
export const DEDICATED_CATEGORY_SLUGS = new Set(['skin_care', 'body_care'])

/** Brand logo used when `/api/v1/categories` returns `image: null`. */
export const CATEGORY_IMAGE_FALLBACK = logo
