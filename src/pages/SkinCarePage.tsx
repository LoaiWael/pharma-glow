...
const SKIN_CARE_ALLOWED_TYPES: ProductType[] = [
  "serum",
  "cream",
  "cleanser",
  "sunscreen",
    ...
    >
      <div className="page-shell mx-auto space-y-8">
        ...
        <PageFadeIn
          ...
          style={{
            backgroundImage: `linear-gradient(to right, rgba(15, 23, 42, 0.85), rgba(15, 23, 42, 0.45)), url('https://images.unsplash.com/photo-1556228720-195a672e8a03?w=1600&q=80')`,
          }}
        >
          <motion.div
          ...
          <aside className="hidden lg:block w-80 shrink-0">
            <PageFadeIn delay={0.2} yOffset={10}>
              <ProductFilters
                ...
                isSidebar={true}
                allowedProductTypes={SKIN_CARE_ALLOWED_TYPES}
              />
            </PageFadeIn>
          </aside>
