    ...
    >
      <div className="page-shell mx-auto space-y-8">
        ...
        <PageFadeIn
          ...
          style={{
            backgroundImage: `linear-gradient(to right, rgba(20, 10, 30, 0.85), rgba(30, 15, 45, 0.5)), url('https://images.unsplash.com/photo-1598440947619-2c35fc9aa908?w=1600&q=80')`,
          }}
        >
          <motion.div
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center gap-2 text-amber-300 font-bold text-xs uppercase tracking-wider bg-amber-950/70 backdrop-blur-md px-3.5 py-1.5 rounded-full border border-amber-500/20 shadow-sm"
            >
              <Tag className="w-3.5 h-3.5 text-amber-400" />
              <span>
                <FormattedMessage id="home.sections.discount.title" />
              </span>
            </motion.div>
            <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight drop-shadow-xs text-white">
              <FormattedMessage id="category.offers.title" />
            </h1>
            <p className="text-gray-200 text-sm md:text-base leading-relaxed max-w-xl">
              <FormattedMessage id="category.offers.description" />
            </p>
          </motion.div>
        </PageFadeIn>
